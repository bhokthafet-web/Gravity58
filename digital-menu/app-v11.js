...
function renderPublicMenu(){
  ...
  if(dashboardButton&&Gravity58Ads?.configured)Gravity58Ads.currentUser().then(account=>{if(account?.email){dashboardButton.hidden=false;dashboardButton.addEventListener('click',premiumPortal)}}).catch(()=>{});
