...
async function loadCloudMenuConfig(recordId,ownerId){
  ...
  try{
    ...
    // The production project uses one shared Appwrite table. Older QR links
    // that omitted the owner can therefore recover the public row by its ID.
