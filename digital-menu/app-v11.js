...
function publicAdSection(r){
  ...
  if(ad)return `<section class="public-ad active-ad ad-cover-placement"><div class="ad-art">${adMediaMarkup(ad,'public-ad-media')}</div><a class="ad-get-offer" href="${html(ad.destinationUrl||'#')}" target="_blank" rel="noopener">Get Offer</a>${adExpiryBadge(ad)}</section>`;
  return `<section class="public-ad ad-placeholder"><div class="ad-art">✦</div><div><p class="eyebrow">GRAVITY58 AD SPACE</p><h3>Your advertisement can appear here</h3><p>Book a restaurant-specific advertising slot through Gravity58.</p></div><button class="btn secondary" id="contactG58Ads">Book Ad Space</button></section>`
}
...
function renderPublicMenu(){
  ...
  app.innerHTML=`<main class="public-menu compact-public-menu">
    ...
    <aside class="header-ad-panel">
      <button class="ad-space-contact" id="contactG58Ads" type="button">Book Ad Space</button>
      ${ad?`<div class="header-active-ad creative-${html(ad.creativeStyle||'spotlight')}"><div class="header-ad-art">${adMediaMarkup(ad,'header-ad-media')}</div><a class="ad-get-offer" href="${html(ad.destinationUrl||'#')}" target="_blank" rel="noopener">Get Offer</a>${adExpiryBadge(ad)}</div>`:`<div class="header-ad-placeholder"><span class="ad-label">GRAVITY58 AD SPACE</span><div class="header-ad-art"><span class="media-fallback">G58</span></div><div><h3>Put your brand beside the menu</h3><p>Book this restaurant promotion slot.</p></div></div>`}
    </aside>
    </section>
